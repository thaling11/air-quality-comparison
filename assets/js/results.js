...
function postGreenHouseGasData(){
    ...
    console.log(postGHG);
    co2Searched.textContent = `Current CO2 Concentration: ${postGHG.co2} ppmv`;
    ch4Searched.textContent = `Current CH Concentration: ${postGHG.ch4} mol/cm²`;
    ozoneSearched.textContent = `Current Ozone Concentration: ${postGHG.ozone} mol/cm²`;
    vaporSearched.textContent = `Current Water Vapor Concentration: ${postGHG.water_vapor} cm`;
};

function postGHGLocal(){
    var postGHGLocal = JSON.parse(localStorage.getItem("localGreenhouse"));
    console.log(postGHGLocal);
    co2Local.textContent = `Current CO2 Concentration Locally: ${postGHGLocal.co2} ppmv`;
    ch4Local.textContent = `Current CH4 Concentration Locally: ${postGHGLocal.ch4} mol/cm²`;
    ozoneLocal.textContent = `Current Ozone Concentration Locally: ${postGHGLocal.ozone} mol/cm²`;
    vaporLocal.textContent = `Current Water Vapor Concentration Locally: ${postGHGLocal.water_vapor} cm`;
};
